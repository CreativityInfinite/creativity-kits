      ...
      <div class="space-y-4">
        ...
        <div class="bg-white dark:bg-gray-800 border rounded-lg p-4">
          <div class="flex justify-between items-center mb-3">
            ...
            <div class="flex gap-2">
              <button @click="encode" class="px-3 py-1 bg-blue-600 hover:bg-blue-700 text-white rounded text-sm">
                编码
              </button>
              <button @click="decode" class="px-3 py-1 bg-green-600 hover:bg-green-700 text-white rounded text-sm">
                解码
              </button>
              <button @click="clearAll" class="px-3 py-1 bg-gray-600 hover:bg-gray-700 text-white rounded text-sm">
                清空
              </button>
            </div>
          </div>
          ...
          <div class="space-y-3">
            ...
            <div v-if="mode === 'file'">
              ...
              <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6">
                ...
                <div class="text-center">
                  ...
                  <button @click="$refs.fileInput.click()" class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded">
                    选择文件
                  </button>
              ...
              <div v-if="selectedFile" class="mt-3 p-3 bg-gray-50 dark:bg-gray-700 rounded border">
                <div class="flex items-center justify-between">
                  ...
                  <button @click="clearFile" class="px-2 py-1 bg-red-600 hover:bg-red-700 text-white rounded text-xs">
                    移除
                  </button>
                </div>
              </div>
            ...
            <div v-if="mode === 'url'">
              ...
              <div class="flex gap-2">
                ...
                />
                <button @click="fetchFromUrl" class="px-3 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded text-sm">
                  获取
                </button>
              </div>
        ...
        <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
          ...
          <div class="space-y-3">
            ...
            <div v-if="options.lineBreaks">
              ...
              <input
                v-model.number="options.lineLength"
                type="range"
                min="32"
                max="128"
                step="8"
        ...
        <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
          ...
          <div class="grid grid-cols-2 gap-2">
            <button @click="loadSampleText" class="px-3 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded text-sm">
              加载示例
            </button>
            <button @click="swapInputOutput" class="px-3 py-2 bg-orange-600 hover:bg-orange-700 text-white rounded text-sm">
              交换内容
            </button>
            <button @click="validateBase64" class="px-3 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded text-sm">
              验证格式
            </button>
            <button @click="generateDataUrl" class="px-3 py-2 bg-pink-600 hover:bg-pink-700 text-white rounded text-sm">
              生成 Data URL
            </button>
          </div>
        </div>
      ...
      <div class="space-y-4">
        ...
        <div class="bg-white dark:bg-gray-800 border rounded-lg">
          <div class="p-3 border-b bg-gray-50 dark:bg-gray-700 flex justify-between items-center">
            ...
            <div class="flex gap-2">
              <button @click="copyOutput" class="px-3 py-1 bg-blue-600 hover:bg-blue-700 text-white rounded text-sm">
                复制
              </button>
              <button @click="downloadResult" class="px-3 py-1 bg-green-600 hover:bg-green-700 text-white rounded text-sm">
                下载
              </button>
            </div>
          </div>
        ...
        <div class="bg-white dark:bg-gray-800 border rounded-lg">
          <div class="p-3 border-b bg-gray-50 dark:bg-gray-700 flex justify-between items-center">
            ...
            <button @click="clearHistory" class="px-3 py-1 bg-gray-600 hover:bg-gray-700 text-white rounded text-sm">
              清空历史
            </button>
          </div>
          <div class="p-4">
            <div v-if="processHistory.length > 0" class="space-y-2 max-h-32 overflow-y-auto">
              <div
                v-for="(history, index) in processHistory.slice(0, 5)"
                :key="index"
              ...
              >
                ...
                <div class="flex gap-1">
                  <button @click="loadFromHistory(history)" class="px-2 py-1 bg-blue-600 hover:bg-blue-700 text-white rounded text-xs">
                    加载
                  </button>
                </div>
              </div>
