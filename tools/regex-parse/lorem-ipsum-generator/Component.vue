<template>
  <div class="space-y-4">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div class="space-y-4">
        <h3 class="font-medium text-lg">Lorem Ipsum 生成器</h3>
        ...
        <div class="space-y-3">
          <div>
            ...
            <div class="grid grid-cols-3 gap-2">
              <div>
                <label class="block text-xs text-gray-500 mb-1">段落数</label>
              ...
              <div>
                <label class="block text-xs text-gray-500 mb-1">每段词数</label>
              ...
              <div>
                <label class="block text-xs text-gray-500 mb-1">句号结尾</label>
                <div class="flex items-center h-[42px] px-3 border rounded-md dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                  ...
                  <label for="withPeriod" class="text-sm">是</label>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            <label class="block text-sm font-medium mb-1">自定义词库（可选，逗号分隔）</label>
      ...
      <div class="space-y-4">
        ...
        <div v-if="result" class="space-y-4">
          <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
            <div class="flex justify-between items-center mb-3">
              <h4 class="font-medium">Lorem 文本</h4>
              <div class="flex gap-2">
            ...
            <div class="mt-3 text-xs text-gray-500 space-y-1">
              ...
              <div>段落数: {{ paragraphs }} · 每段词数: {{ wordsPerParagraph }}</div>
            </div>
          </div>
        ...
        <div v-if="!result" class="text-center py-12 text-gray-500 dark:text-gray-400">
          ...
          <div class="text-lg mb-2">Lorem Ipsum</div>
          <div class="text-sm">生成占位文本用于排版与演示</div>
        </div>
      ...
      <div class="space-y-2 max-h-48 overflow-y-auto">
        <div v-for="(item, index) in history" :key="index" class="bg-gray-50 dark:bg-gray-800 rounded p-3 text-sm">
          <div class="flex justify-between items-start mb-2">
            <div>
              <div class="font-medium">段落 {{ item.paragraphs }} · 词数 {{ item.wordsPerParagraph }}</div>
