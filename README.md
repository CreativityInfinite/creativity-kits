...
- Streak & Overall Stats
    ...
    <img src="https://streak-stats.demolab.com?user=CreativityInfinite&theme=radical" width="49%">
    <img src="https://github-readme-stats.vercel.app/api?username=CreativityInfinite&show_icons=true&theme=radical" width="49%">
...
- name: CI
  ...
  with:
  node-version: 20
  cache: npm - run: npm ci - run: npm run lint - run: npm run test - run: npm run build
...
- Vitest config provided (tests/\*_/_.test.ts)
